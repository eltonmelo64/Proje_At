...
import fotoCarlos from '../../images/Carlos.jpg';
  ...
  const handleSubmit = (e) => {
    ...
    if (inputValue.trim()) {
      const newMessage = {
        ...
        text: inputValue,
        img: fotoGato
        // "https://i.pinimg.com/280x280_RS/39/82/58/3982584222ebfad41d818e9de2b80197.jpg"      URL da imagem do seu perfil https://via.placeholder.com/50
      };
